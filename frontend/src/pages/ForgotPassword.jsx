      ...
      <div className={styles.formCard} style={{ maxWidth: 440, width: '100%' }}>
        {sent ? (
          <div className={styles.centeredBlock}>
            ...
            <Link to="/login" className={styles.switchLink} style={{ marginTop: 24, display: 'inline-flex', alignItems: 'center', gap: 6 }}>
          ...
          <>
            ...
            <p className={styles.switchText}>
              <Link to="/login" className={styles.switchLink} style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
                <FiArrowLeft size={14} /> Back to sign in
              </Link>
            </p>
          </>
